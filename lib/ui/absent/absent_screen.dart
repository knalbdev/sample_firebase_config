...
class _AbsentScreenState extends State<AbsentScreen> {
  ...
  var categoriesList = <String>[
    "Please Choose:", "Others", "Permission", "Sick"
  ];
  final CollectionReference dataCollection = FirebaseFirestore.instance.collection('atendance');
                                      ...
                                      return Theme(
                                        data: Theme.of(context).copyWith(
                                          colorScheme: const ColorScheme.light(onPrimary: Colors.white,
                                              onSurface: Colors.white, primary: Colors.blueAccent),
                      ...
                      child: Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            borderRadius: BorderRadius.circular(20),
                            onTap: () {
                              if (controllerName.text.isEmpty || dropValueCategories == "Please Choose:"
  ...
  Future<void> submitAbsen(String nama, String keterangan, String from, String until) async {
    ...
    dataCollection.add({'address': '-', 'name': nama,
      'description': keterangan, 'datetime': '$from-$until'}).then((result) {
      setState(() {
